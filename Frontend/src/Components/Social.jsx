...
function Social() {
  ...
  useEffect(() => {
    const getUserId = async () => {
      try {
        const response = await axios.post(`${import.meta.env.VITE_REACT_APP_BACKEND_URL}/api/getuserid`, { username: username });
  ...
  useEffect(() => {
    const getPosts = async () => {
      try {
        ...
        const response = await axios.post(`${import.meta.env.VITE_REACT_APP_BACKEND_URL}/api/allposts`);
  ...
  const handleAddPost = async () => {
    try {
      ...
      const response = await axios.post(`${import.meta.env.VITE_REACT_APP_BACKEND_URL}/api/addpost`, formData, {
